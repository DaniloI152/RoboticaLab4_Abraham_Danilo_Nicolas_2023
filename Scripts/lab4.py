...
if __name__ == '__main__':
    try:
        ...
        print("Laboratorio 4 de robótica")
        print("2023-1")
        print("Integrantes: Abraham Másmela, Danilo Insuasty, Nicolas Prieto")
        ...
        pos1Degree=[-25,15,-20,20,0] 
        pos2Degree=[35,-35,30,-30,0]
        pos3Degree=[-85,20,-55,17,0] 
        ...
        print("Posicion 2: [-25,15,-20,20,0] ")
        print("Posicion 3: [35,-35,30,-30,0] ")
        print("Posicion 4: [-85,20,-55,17,0] ")
